...
| **Q-DATA-03** | 최신 작업본은 전체 계획 단위로 마지막 도착 저장이 승리한다. IndexedDB는 오프라인 사본이며 계획별 상파울루 날짜 하루 보관본을 한 개씩 유지한다. 특별 스냅샷·셀별 이력·외부 백업은 Phase 6A에서 제외한다. | 자동 저장·오프라인 복구·보존 범위 |
